...
namespace IDEmpresaJAL.DAL.Migrations
{
    ...
    [Migration("20241108131936_addProgObservaciones")]
    partial class addProgObservaciones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IDEmpresaJAL.Entity.Models.TProgramas", b =>
                {
                    ...
                    b.Property<int>("EstatusProgramaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IDEmpresaJAL.Entity.Models.TProgramasEstatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TProgramasEstatus");
                });

            modelBuilder.Entity("IDEmpresaJAL.Entity.Models.TProgramasObservaciones", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TProgramasObservaciones");
                });
            ...
            modelBuilder.Entity("IDEmpresaJAL.Entity.Models.TProgramas", b =>
                {
                    ...
                    b.HasOne("IDEmpresaJAL.Entity.Models.TProgramasEstatus", "EstatusPograma")
                        .WithMany()
                        .HasForeignKey("EstatusProgramaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
