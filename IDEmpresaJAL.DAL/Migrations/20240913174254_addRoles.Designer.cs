...
namespace IDEmpresaJAL.DAL.Migrations
{
    ...
    [Migration("20240913174254_addRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IDEmpresa.Entity.Models.CRecurso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IDEmpresa.Entity.Models.CRecursoContenedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IDEmpresa.Entity.Models.CRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IDEmpresa.Entity.Models.RRolRecurso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IDEmpresa.Entity.Models.CRecurso", b =>
                {
                    b.HasOne("IDEmpresa.Entity.Models.CRecursoContenedor", "Contenedor")
                        .WithMany()
            ...
            modelBuilder.Entity("IDEmpresa.Entity.Models.RRolRecurso", b =>
                {
                    b.HasOne("IDEmpresa.Entity.Models.CRecurso", "Recurso")
                        .WithMany()
                        .HasForeignKey("RecursoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IDEmpresa.Entity.Models.CRoles", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
